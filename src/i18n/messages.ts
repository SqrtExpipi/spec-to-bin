...
const en = {
  ...
  "toolbar.restoreSaved": "Restore saved",
  "toolbar.undo": "Undo",
  "toolbar.redo": "Redo",
  ...
  "template.defaultEndian": "Default Endian",
  "template.defaultEncoding": "Default Encoding",
  "template.fileNameFallback": "An empty name will be saved as {name}.",
  ...
  "panel.selectedField": "Active field",
  ...
  "json.copy": "Copy JSON",
  "json.close": "Close JSON editor",
  "json.applyBeforeSave": "Apply the JSON editor changes before saving the definition file.",
  "json.invalid": "The JSON text is invalid.",
  "json.syntaxError": "Invalid JSON.",
  "json.syntaxErrorAt": "Invalid JSON near line {line}, column {column}.",
  ...
  "toast.newTemplate": "Started a new template.",
  "toast.savedRestored": "Restored the last opened or saved definition.",
  "toast.restoreFailed": "The saved definition could not be restored.",
  "toast.sampleLoaded": "Sample loaded.",
  "toast.rowsCopied": "Copied {count} rows inside the editor.",
  "toast.rowsDeleted": "Deleted {count} rows.",
  ...
  "confirm.newTemplate": "Discard unsaved changes and start a new template?",
  "confirm.restoreSaved": "Discard unsaved changes and restore the last opened or saved definition?",
  ...
  "batch.selectHint": "Select rows for batch actions",
  "batch.active": "Active: {name}",
  "batch.clipboard": "Clipboard: {count} rows",
  "batch.selectAll": "Select all rows",
  "batch.selectRow": "Select {name}",
  "batch.duplicate": "Duplicate",
  "batch.copy": "Copy",
  "batch.paste": "Paste",
  "batch.pasteHelp": "Paste below the active row",
  ...
  "testValue.asciiMax": "Repeat A-Z to the maximum byte length",
  ...
  "testValue.targetSummary": "Targets: {targets} / Excluded: {excluded}",
  "testValue.reason.notString": "Not a string field",
  "testValue.reason.fixed": "Fixed value",
  "testValue.reason.length": "Invalid fixed length",
  "testValue.reason.encoding": "Encoding needs review",
  "testValue.reason.cannotFill": "Cannot fill this byte length with the selected settings",
  ...
  "help.defaultEndian": "Used by multi-byte numeric fields whose Format is set to default.",
  "help.defaultEncoding": "Used by string fields whose Format is set to default.",
...
const ja: Record<MessageKey, string> = {
  ...
  "toolbar.newTemplate": "新規作成",
  "toolbar.restoreSaved": "保存時点に戻す",
  "toolbar.undo": "元に戻す",
  "toolbar.redo": "やり直す",
  ...
  "template.defaultEndian": "既定Endian",
  "template.defaultEncoding": "既定Encoding",
  "template.fileNameFallback": "名前が空の場合は{name}として保存します。",
  ...
  "json.apply": "JSONを反映",
  "json.copy": "JSONをコピー",
  "json.close": "JSON編集を閉じる",
  "json.applyBeforeSave": "JSON編集の変更を反映してから定義ファイルを保存してください。",
  "json.invalid": "JSONテキストが不正です。",
  "json.syntaxError": "JSONが不正です。",
  "json.syntaxErrorAt": "{line}行目、{column}列目付近のJSONが不正です。",
  ...
  "toast.newTemplate": "新しいテンプレートを開始しました。",
  "toast.savedRestored": "最後に開いた、または保存した定義へ戻しました。",
  "toast.restoreFailed": "保存時点の定義を復元できませんでした。",
  "toast.sampleLoaded": "サンプルを読み込みました。",
  "toast.rowsCopied": "{count}行をエディタ内にコピーしました。",
  "toast.rowsDeleted": "{count}行を削除しました。",
  ...
  "confirm.newTemplate": "未保存の変更を破棄して新しいテンプレートを開始しますか？",
  "confirm.restoreSaved": "未保存の変更を破棄して、最後に開いた、または保存した定義へ戻しますか？",
  ...
  "batch.selectHint": "行を選択するとまとめて操作できます",
  "batch.active": "アクティブ: {name}",
  "batch.clipboard": "コピー済み: {count}行",
  "batch.selectAll": "すべての行を選択",
  "batch.selectRow": "{name}を選択",
  "batch.duplicate": "複製",
  "batch.copy": "コピー",
  "batch.paste": "貼り付け",
  "batch.pasteHelp": "アクティブ行の下に貼り付けます",
  ...
  "testValue.mode": "生成方式",
  "testValue.asciiMax": "A-Zを繰り返して最大Byteまで埋める",
  ...
  "testValue.targetSummary": "生成対象: {targets}件 / 対象外: {excluded}件",
  "testValue.reason.notString": "string項目ではありません",
  "testValue.reason.fixed": "固定値です",
  "testValue.reason.length": "固定長が不正です",
  "testValue.reason.encoding": "Encodingの確認が必要です",
  "testValue.reason.cannotFill": "選択した設定では指定Byte長にできません",
  ...
  "help.defaultEndian": "Formatがdefaultの複数byte数値項目で使用するbyte順です。",
  "help.defaultEncoding": "Formatがdefaultのstring項目で使用する文字コードです。",
